...
(function($) {  // Avoid conflicts with other libraries
	...
	if (imcger.radialProgBar.getBrightness($('#file-list td').css('background-color')) < 128) {
	...
	$(document).ready(function() {
		phpbb.plupload.uploader.bind('FilesAdded', function(up, files) {
			// Set the colour for the progressbar cover, depending on the background
